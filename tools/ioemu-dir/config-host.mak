...
# Configured with: '/XenSource/Bottleneck/tools/../tools/ioemu-qemu-xen/configure' '--disable-gfx-check' '--disable-curses' '--disable-slirp' '--prefix=/usr'
prefix=/usr
bindir=${prefix}/bin
...
VERSION=0.10.2
SRC_PATH=/XenSource/Bottleneck/tools/ioemu-qemu-xen
VPATH=/XenSource/Bottleneck/tools/ioemu-qemu-xen
...
XEN_ROOT=/XenSource/Bottleneck/tools/..
QEMU_ROOT ?= .
